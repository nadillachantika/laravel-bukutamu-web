    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('kesansaran.update', $kesansaran)  }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="tamu_id" class=" select2 @error('tamu_id') is-invalid @enderror"
                                    ...
                                    <option value="{{ $tamu->id }}" {{ $kesansaran->tamu_id == $tamu->id ? 'selected' : '' }}>
                                        {{ $tamu->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="kesan" value="{{ $kesansaran->kesan }}">
                                @error('kesan')
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="saran" value="{{ $kesansaran->saran }}">
                                @error('saran')
